        ...
        <div class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 text-center lg:max-w-full lg:mt-16 lg:grid-cols-3">
                ...
                <div class="p-8 xl:px-12">
                    ...
                    <ul class="inline-flex flex-col items-start space-y-5 text-left mt-9">
                        ...
                        <li class="inline-flex items-center space-x-2">
                            ...
                            <span class="pb-0.5 text-base font-medium text-gray-900 border-b border-black border-dashed"> Actualizaci&oacute;n del Stock </span>
                        </li>
                    </ul>

                    <a href="gestionVenta.jsp" title="" class="inline-flex items-center justify-center px-10 py-4 mt-10 text-base font-semibold text-white transition-all duration-200 rounded-md bg-gradient-to-r from-fuchsia-600 to-blue-600 hover:opacity-80 focus:opacity-80" role="button"> Acceder a Ventas </a>
                    <p class="mt-4 text-sm text-gray-500">Acceder</p>
                </div>
            </div>
            ...
            <div class="overflow-hidden bg-white border-2 border-gray-100 rounded-md">
                <div class="p-8 xl:px-12">
                    ...
                    <p class="mt-3 text-base text-gray-600">---</p>
                    ...
                    <ul class="inline-flex flex-col items-start space-y-5 text-left mt-9">
                        ...
                        <li class="inline-flex items-center space-x-2">
                            ...
                            <span class="pb-0.5 text-base font-medium text-gray-900 border-b border-black border-dashed"> --- </span>
                        </li>
                    </ul>
